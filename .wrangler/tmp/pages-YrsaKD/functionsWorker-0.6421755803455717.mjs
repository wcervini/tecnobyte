...
// api/contact.js
var FROM_EMAIL = "contacto@tecnobyte.es";
var TO_EMAIL = "contacto@tecnobyte.es";
async function onRequest(context2) {
  ...
  try {
    ...
    return new Response(
      formWithError("Error al enviar el mensaje. Intenta de nuevo m\xE1s tarde."),
...
function formSuccess() {
  return `<div class="text-center py-12">
    ...
    <h3 class="font-display text-2xl font-bold text-white mb-2">\xA1Mensaje enviado!</h3>
    <p class="text-gray-400">Gracias por contactarnos. Te responderemos a la brevedad.</p>
  </div>`;
}
__name(formSuccess, "formSuccess");
...
__name(formWithError, "formWithError");

// ../.wrangler/tmp/pages-YrsaKD/functionsRoutes-0.9986949386613269.mjs
var routes = [
  {
...
// ../.wrangler/tmp/bundle-1WoyJC/middleware-insertion-facade.js
...
// ../.wrangler/tmp/bundle-1WoyJC/middleware-loader.entry.ts
...
//# sourceMappingURL=functionsWorker-0.6421755803455717.mjs.map
